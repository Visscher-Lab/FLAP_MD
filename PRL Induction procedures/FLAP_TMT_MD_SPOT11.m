...
try
    prompt={'Participant name', 'day','site? UCR(1), UAB(2), Vpixx(3)','Scotoma? yes (1), no(0)', 'demo (0) or session (1)',  'eye? left(1) or right(2)', 'Calibration? yes (1), no(0)', 'Eyetracker(1) or mouse(0)?','Site with Vpixx? UCR(1), UAB(2)', 'font size (default 20)', 'circle size (default 1.25)'};

    name= 'Parameters';
    numlines=1;
        defaultanswer={'test','1', '3', '1','1','2','0','0','1', '20', '1.25' };
    ...
    CommonParametersTMT_MD % load parameters for time and space
