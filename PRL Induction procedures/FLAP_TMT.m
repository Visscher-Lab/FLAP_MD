...
try
    ...
    prompt={'Participant name', 'day', 'demo (0) or session (1)', 'Calibration(1), Validation (2), or nothing(0)', 'Site with Vpixx? UCR(1), UAB(2)'};
    ...
    sitevpixx = str2num(answer{5,:}); %1=UCR, 2=UAB PD: I added this to take care of screen differences between the sites 7/26/23
    scotomavpixx=0;
