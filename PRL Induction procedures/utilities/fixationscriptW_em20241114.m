...
if inward==1
    if fixation_location_prl ==1 ||fixation_location_url==1 %we are showing x fixation aids
    ...
    elseif fixation_location_prl ==2 ||fixation_location_url==2 %we are showing t fixation aids
    Screen('FillArc',w,color_w,imageRectDown,360-(widthWag/2)-180,widthWag)
    Screen('FillArc',w,color_w,imageRectLeft,90-(widthWag/2)-180,widthWag)
    Screen('FillArc',w,color_w,imageRectUp,180-(widthWag/2)-180,widthWag)
    Screen('FillArc',w,color_w,imageRectRight,270-(widthWag/2)-180,widthWag)
    end
